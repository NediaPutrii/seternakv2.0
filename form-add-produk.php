            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <select class="form-select" name="satuan" aria-label=".form-select-lg example">
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <div class="number">
                    ...
                    <input id="stock" type="text" name="stock" value="0" onkeypress="return hanyaAngka(event)" required />
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <textarea class="form-control" id="deskripsi_produk" name="deskripsi_produk" placeholder="masukkan deskripsi produk" rows="3" required></textarea>
                </div>
