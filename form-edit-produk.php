            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <input type="number" class="form-control" id="harga" name="harga" onkeypress="return hanyaAngka(event)" value="<?php echo $pecah['harga'] ?>">
                </div>
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <select class="form-select form-select-sm" name="satuan" aria-label=".form-select-lg example">
                    <option selected><?php echo $pecah['satuan'] ?></option>
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <div class="number">
                    ...
                    <input id="stock" type="text" name="stock" onkeypress="return hanyaAngka(event)" value="<?php echo $pecah['stok'] ?>" />
